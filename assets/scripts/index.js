  ...
  $('.productions').each(function() {
    ...
    function logMeasurements(reason) {
      try {
        ...
        console.log('activeIndex:', activeIndex, 'slidesCount:', $slides.length);
        console.log('viewportRect:', { x: viewportRect.x, width: viewportRect.width });
        console.log('trackRect:', { x: trackRect.x, width: trackRect.width, scrollWidth: $track[0].scrollWidth });
        console.log('gap:', gap, 'computedStyle.gap:', gapStr);
        console.log('activeRect:', { x: activeRect.x, width: activeRect.width });
        console.log('active.position().left:', posLeft, 'active.offsetLeft:', offLeft);
    ...
    function updatePosition() {
      ...
      console.log('Align using rects:', { viewportLeft: viewportLeft, targetLeft: targetLeft, currentTX: currentTX, delta: delta, alignOffset: alignOffset, nextTX: translateX });
